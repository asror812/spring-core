...
class TrainingControllerTest {
    ...
    void addTraining() throws Exception {
        TrainingCreateRequestDTO createDTO = new TrainingCreateRequestDTO("a", "a", "Swimming-1", new Date(), 1.5);
    ...
    void getTraineeTrainings() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/trainees/{username}/trainings", "asror.r")
                .header("Authorization", "Bearer " + jwtService.generateToken("a.a"))
                .accept(MediaType.APPLICATION_JSON))
    ...
    void getTrainerTrainings() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/trainers/{username}/trainings", "asror.r")
                .header("Authorization", "Bearer " + jwtService.generateToken("a.a"))
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk())
